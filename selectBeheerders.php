...
if ($result->num_rows > 0) {
    ...
    ?>
    <div class="bg-red-400 w-4/4 m-auto mt-5 p-2 rounded-md mb-5" style="display: block;

    width: 80%;
    position: relative;">
        <div class="text-center text-white text-2xl"><?php echo "Er zijn geen beheerders";?></div>
    </div>
    <?php
}
$conn->close();
