...
WHERE Rol=3 and NOT EXISTS 
    ...
    if (mysqli_num_rows($result) > 0) {
        foreach ($result as $row) {
            ...
            <a href="updateOpdracht.php?OpdrachtId=<?php echo $_GET['OpdrachtId']; ?>&UserId=<?php echo $row['UserId']; ?>&KamerId=<?php echo $_GET['KamerId']; ?>"
               onclick="return confirm('Wilt u deze schoonmaak(st)er koppelen?')">
                        ...
                        <div class="text-xl ">
                            <div class="  p-2  justify-between items-center flex" style="align-items: revert;">
                                <div class="text-center m-auto flex  ">
                                    ...
                                    <div class="w-5/5 m-auto mr-5 text-center"><b>Schoonmaak(st)er Naam:</b></div>
        ...
        <div class="text-center text-l text-red-600">
            Er zijn geen schoonmaak(st)ers beschikbaar tussen de aangegeven tijden!
            <div class="text-l">
                Hieronder ziet u de eerst beschikbare schoonmaak(st)ers
            </div>
        </div><br><?php
        include "geenSchoonmakers.php";
    }
}
