                ...
                <div class="w-5/5 max-h-full">
                    <div class="text-xl ">
                        <div class="  p-2 justify-between items-center flex" style="align-items: revert;">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="m-auto text-center w-5/5 mr-5"><b>Duur</b></div>
                                <input type="hidden" name="taak[<?php echo $vastTaakId; ?>][taakId]"  value="<?php echo $vastTaakId; ?>">
                                <input type="number" class="rounded-md m-auto flex " style="color: black; border: 1px solid;" value=<?php echo $row['Duur'];?> name="taak[<?php echo $vastTaakId; ?>][duur]" min="1" required /><br>
                            </div>
                ...
                <div class="text-xl ">
                    <div class="  p-2 justify-between items-center flex" style="align-items: revert;">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <input type="hidden" name="taak[<?php echo $TaakId; ?>][taakId]"  value="<?php echo $TaakId; ?>">
                            <div class="w-5/5 mr-5 m-auto text-center"><b>Taak</b></div>
                            <input type="text" class="rounded-md" name="taak[<?php echo $TaakId;?>][naam]" style="border: 1px solid;" value="<?php echo $row1["Taak"];?>">

                        </div>
                        <div class="flex justify-between items-center">
                            <div class="m-auto text-center w-5/5 mr-5"><b>Duur</b></div>
                            <input type="hidden" name="taak[<?php echo $TaakId; ?>][taakId]"  value="<?php echo $TaakId; ?>">
                            <input type="number" class="rounded-md m-auto flex " style="color: black; border: 1px solid;" value='<?php echo $row1['Duur'];?>' name="taak[<?php echo $TaakId; ?>][duur]" min="1" required /><br>
                        </div>
                        <div class="flex justify-between items-center">
                            <a href="deleteTaak.php?TaakId=<?php echo $TaakId;?>&KamerId=<?php echo $_GET['KamerId'];?>"><i class="fa-regular fa-trash-can"></i></a>
                        </div>
                    </div>
...
<script>
                        ...
                        <div class="w-5/5 max-h-full">
                            <div class="text-xl ">
                                <div class="vraag-counter  p-2 justify-between items-center flex" style="align-items: revert;">
                                    <input type="hidden" value="">
                                    <div class="flex justify-between items-center">
                                        <div class="w-1/5 m-auto text-center"><b>Nieuwe Taak</b></div>
                                        <input type="text" class="bg-white rounded-md w-3/4 m-2 p-2 " value="Taak ${formCount}" name="nieuweTaak[${formCount}][naam]"  required>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <div class="m-auto text-center w-1/5"><b>Duur</b></div>
                                        <input type="number" class="bg-white rounded-md w-3/4 m-2 p-2" value="30" name="nieuweTaak[${formCount}][duur]" required >
                                    </div>

                                    <div class="" style=" font-size: 12px; justify-content: end;">
                                        <a onclick="deleteTeamForm(${formCountClone})"><b></b><i class=" p-2 fa-solid fa-trash"></i>
                                        </a>
                                    </div>
                                </div>
    ...
    <a   class="text-center color-red " ><div class="text-center ml-auto mr-auto m-5 mt-5 " style="height: 50px; width: 40%;border-radius: 10px;color: #000; display: flex;justify-content: center;align-items: center;"><i class="fa-solid fa-plus pr-2"></i>Taak Aanmaken</div></a>
    </div>
